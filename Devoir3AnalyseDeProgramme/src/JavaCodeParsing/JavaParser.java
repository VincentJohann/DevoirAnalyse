...
public class JavaParser implements JavaParserConstants {
  ...
  private Stack<String> CurrentClass;
  ...
  private boolean IsVariableDeclare;
  ...
  private Parameter AttributeIdentifier;
 ...
 private String InMethodCallerType;
 ...
 public JavaParser(List<String> filenames, MainController maincontroller)
  ...
  public void ExecuteParse(int choice)
  {
  ...
  public void ReturnResult(int choice)
  {
    switch (choice)
    {
      case 1 : MyMaincontroller.SetResultMsg(MyMaincontroller.GetArbre().GetAnalyseAttribute1Statistic());
      break;
      case 2 : MyMaincontroller.SetResultMsg(MyMaincontroller.GetArbre().GetAnalyseAttribute2Statistic());
      break;
      case 3 : MyMaincontroller.SetResultMsg(MyMaincontroller.GetArbre().GetAnalyseUML3Statistic());
      break;
      case 4 : MyMaincontroller.SetResultMsg(MyMaincontroller.GetArbre().GetAnalyseMethod4Stats());
      break;
      case 5 : MyMaincontroller.SetResultMsg(MyMaincontroller.GetArbre().GetAnalyseMethod5Stats());
      break;
      default : MyMaincontroller.SetResultMsg("");
      break;
    }
  }
...
// Handle classes, interfaces, enums, and annotations.
  ...
  Token t;
    ...
    if (IsInClass)
    {
      MaClasse newClass = new MaClasse(t.toString());
      if (CurrentClass.peek().equals(""))
      {
        CurrentClass.push(t.toString());
        MyMaincontroller.AddClass(newClass);
      }
      else
      {
        CurrentClass.push(t.toString());
 ...
 Token attribut;
  ...
  IsVariableDeclare=true;
  if(LastModifier.equals("public")) {
        MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).setCompteurPublic(
        MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).getCompteurPublic()+1);
    }else if(LastModifier.equals("protected")) {
                MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).setCompteurProtected(
        MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).getCompteurProtected()+1);
        }
        else if(LastModifier.equals("private")) {
        MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).setCompteurPrivate(
        MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).getCompteurPrivate()+1);
        }
        //LastModifier="";
 ...
 Token t;
    t = jj_consume_token(IDENTIFIER);
    if(IsInMethod && !ReturnType.equals("")) {
      Parameter params=new Parameter(ReturnType,t.toString());
      MethodName.getParameter().add(params);
      ReturnType="";
      }

// Declaration des variables/Attributs des Classes

     AttributeIdentifier.setName(t.toString());
     AttributeIdentifier.setModifier(LastModifier);
     MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).getAttributs().add(AttributeIdentifier);
     AttributeIdentifier= new Parameter("","");
    label_12:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  IsInMethod=true;
    ...
    MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).getMethodes().add(MethodName);
    MethodName= new Method("","public");
    IsInMethod=false;
  }
 ...
 Token t;
    ...
    if(IsInMethod) {
      ...
      MethodName.setName(ReturnType+"."+t.toString());
      }
        if(IsInBlock) {
                if(ReturnType.equals(""))
                ReturnType="void";
                InnerMethod.setName(ReturnType+"."+t.toString());
           }
    FormalParameters();
    label_14:
    while (true) {
  ...
  MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).setCompteurReference(
  MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).getCompteurReference()+1);
  }
  IsVariableDeclare=false;
    if (jj_2_18(3)) {
      PrimitiveType();
 ...
 Token t;
    t = jj_consume_token(IDENTIFIER);
                AttributeIdentifier.setType(t.toString());
        if(!IsInMethod) {
        MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).addVisibility(t.toString()); }

       if(IsExtended) {
        MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).addParent(t.toString());
         }
          if(IsImplements) {
        MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).addInterface(t.toString());
         }
  ...
  if(IsVariableDeclare) {
  MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).setCompteurSimple(
  MyMaincontroller.GetArbre().GetClassByName(CurrentClass.peek()).getCompteurSimple()+1);
 }
 IsVariableDeclare=false;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case BOOLEAN:
 ...
 Token t2;
  ...
  if(IsInBlock) {
    Invoker=t.toString();
    InnerMethodName=t.toString()+"."+t2.toString();
     }
    }
  }
  ...
  final public void Arguments() throws ParseException {
    ...
    jj_consume_token(RPAREN);
     if(IsInBlock) {
      ...
      InnerMethod.setName(InnerMethodName);
      InnerMethod.setInvoker(Invoker);
      InnerMethod.getParameter().add(params);
      MethodName.getInnerMethods().add(InnerMethod);
      Invoker="";
      InnerMethodName="";
      InnerMethod=new Method("","public");
      ReturnType="";
